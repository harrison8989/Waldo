...
def A (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _A (_waldo_classes["Endpoint"]):
        ...
        def b(self):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                _to_return = self._endpoint_func_call_prefix__waldo__b(_root_event,_ctx ,[])
        ...
        def _endpoint_func_call_prefix__waldo__b(self,_active_event,_context,_returning_to_public_ext_array=None):
    ...
    return _A(_waldo_classes,_host_uuid,_conn_obj,*args)
def _A (_waldo_classes,_host_uuid,_conn_obj,*args):
    class __A (_waldo_classes["Endpoint"]):
        def __init__(self,_waldo_classes,_host_uuid,_conn_obj):
    ...
    return __A(_waldo_classes,_host_uuid,_conn_obj,*args)
