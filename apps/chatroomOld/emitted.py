...
def Client (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Client (_waldo_classes["Endpoint"]):
        def __init__(self,_waldo_classes,_host_uuid,_conn_obj,n):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                _to_return = self._onCreate(_root_event,_ctx ,n,[])
        ...
        def _onCreate(self,_active_event,_context,n,_returning_to_public_ext_array=None):
            ...
            (self._partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG(_active_event,_context,(_context.get_val_if_waldo(_context.global_store.get_var_if_exists("0__name"),_active_event) + _context.get_val_if_waldo(' has connected!' ,_active_event)),) if _context.set_msg_send_initialized_bit_false() else None)
        ...
        def _endpoint_func_call_prefix__waldo__getName(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if _returning_to_public_ext_array != None:
                ...
                return _context.flatten_into_single_return_tuple(_context.global_store.get_var_if_exists("0__name") if 0 in _returning_to_public_ext_array else _context.de_waldoify(_context.global_store.get_var_if_exists("0__name"),_active_event))


            # otherwise, use regular return mechanism... do not de-waldo-ify
            return _context.flatten_into_single_return_tuple(_context.global_store.get_var_if_exists("0__name"))
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG(self,_active_event,_context,msg=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "9__msg", _context.convert_for_seq_local(msg,_active_event,self._host_uuid)
                    )
                ...
                result = ""
                _context.sequence_local_store.add_var(
                    "10__result",_context.convert_for_seq_local(result,_active_event,self._host_uuid))
            ...
            return _context.sequence_local_store.get_var_if_exists("10__result")
...
def Server (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Server (_waldo_classes["Endpoint"]):
        def __init__(self,_waldo_classes,_host_uuid,_conn_obj,init_display_msg_func):
            ...
            self._global_var_store.add_var(
                '6__display_msg_func',self._waldo_classes["WaldoFunctionVariable"](  # the type of waldo variable to create
                '6__display_msg_func', # variable's name
                _host_uuid, # host uuid var name
                False,  # if peered, True, otherwise, False
        ...
        def _onCreate(self,_active_event,_context,init_display_msg_func,_returning_to_public_ext_array=None):
            ...
            if not _context.assign(_context.global_store.get_var_if_exists("6__display_msg_func"),_tmp0,_active_event):
                pass
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__receiveMSG(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.signal_call(_active_event,_context.global_store.get_var_if_exists("6__display_msg_func"),_context.sequence_local_store.get_var_if_exists("9__msg"),)
