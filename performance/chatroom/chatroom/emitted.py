...
def Client (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Client (_waldo_classes["Endpoint"]):
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG(self,_active_event,_context,msg=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "7__msg", _context.convert_for_seq_local(msg,_active_event,self._host_uuid)
                    )
                ...
                result = ""
                _context.sequence_local_store.add_var(
                    "8__result",_context.convert_for_seq_local(result,_active_event,self._host_uuid))
            ...
            return _context.sequence_local_store.get_var_if_exists("8__result")

        ### User-defined message receive blocks ###

        def _partner_endpoint_msg_func_call_prefix__waldo__sendActive(self,_active_event,_context,_returning_to_public_ext_array=None):

            _tmp0 = True 
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("10__temp"),_tmp0,_active_event):
                pass

            _tmp0 = _context.sequence_local_store.get_var_if_exists("10__temp")
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("12__result"),_tmp0,_active_event):
                pass
    ...
    class _Server (_waldo_classes["Endpoint"]):
        ...
        def getActive(self):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                # to Waldo variables, and de-waldo-ifying them outside of the
                # transaction might return over-written/inconsistent values.
                _to_return = self._endpoint_func_call_prefix__waldo__getActive(_root_event,_ctx ,[])
                # try committing root event
                _root_event.request_commit()
                _commit_resp = _root_event.event_complete_queue.get()
                if isinstance(_commit_resp,self._waldo_classes["CompleteRootCallResult"]):
        ...
        def _endpoint_func_call_prefix__waldo__getActive(self,_active_event,_context,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
            ...
            if _returning_to_public_ext_array != None:
                ...
                return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__SeqActive(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None) if 0 in _returning_to_public_ext_array else _context.de_waldoify((self._partner_endpoint_msg_func_call_prefix__waldo__SeqActive(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None),_active_event))


            # otherwise, use regular return mechanism... do not de-waldo-ify
            return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__SeqActive(_active_event,_context,) if _context.set_msg_send_initialized_bit_false() else None))
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqActive(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                temp = _context.get_val_if_waldo(False ,_active_event)
                _context.sequence_local_store.add_var(
                    "10__temp",_context.convert_for_seq_local(temp,_active_event,self._host_uuid))
                result = False
                _context.sequence_local_store.add_var(
                    "12__result",_context.convert_for_seq_local(result,_active_event,self._host_uuid))
            ...
            _threadsafe_queue = self._waldo_classes["Queue"].Queue()
            _active_event.issue_partner_sequence_block_call(
                _context,'sendActive',_threadsafe_queue, '_first_msg')
            _queue_elem = _threadsafe_queue.get()
            ...
            return _context.sequence_local_store.get_var_if_exists("12__result")
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__receiveMSG(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.signal_call(_active_event,_context.global_store.get_var_if_exists("2__display_msg_func"),_context.sequence_local_store.get_var_if_exists("7__msg"),)
