...
def Server (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Server (_waldo_classes["Endpoint"]):
        ...
        def _endpoint_func_call_prefix__waldo__sendMSG(self,_active_event,_context,msg,num,_returning_to_public_ext_array=None):
            ...
            self._waldo_classes["WaldoSingleThreadListVariable"]("garbage",self._host_uuid,False,list(range(_context.get_val_if_waldo(0 ,_active_event),_context.get_val_if_waldo(num,_active_event),_context.get_val_if_waldo(1 ,_active_event))))
