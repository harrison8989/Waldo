...
def Client (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Client (_waldo_classes["Endpoint"]):
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            #import pdb
            #pdb.set_trace() #15 threads made so far
            #.09
            ...
            #1.59 .1 second to complete the other endpoint task
            #1.69 2 threads mades per additional sequence so far BUT THAT'S IT THAT CAN'T BE IT
            return
