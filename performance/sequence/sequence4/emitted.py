            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "6__msg", _context.convert_for_seq_local(msg,_active_event,self._host_uuid)
                    )
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG2(self,_active_event,_context,msg=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "10__msg", _context.convert_for_seq_local(msg,_active_event,self._host_uuid)
                    )
                ...
                result = ""
                _context.sequence_local_store.add_var(
                    "11__result",_context.convert_for_seq_local(result,_active_event,self._host_uuid))
            ...
            return _context.sequence_local_store.get_var_if_exists("11__result")
    ...
    class _Server (_waldo_classes["Endpoint"]):
        def __init__(self,_waldo_classes,_host_uuid,_conn_obj,init_display_msg_func):
            ...
            self._global_var_store.add_var(
                '3__display_msg_func',self._waldo_classes["WaldoFunctionVariable"](  # the type of waldo variable to create
                '3__display_msg_func', # variable's name
        ...
        def _onCreate(self,_active_event,_context,init_display_msg_func,_returning_to_public_ext_array=None):
            ...
            if not _context.assign(_context.global_store.get_var_if_exists("3__display_msg_func"),_tmp0,_active_event):
                pass
