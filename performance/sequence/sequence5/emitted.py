...
def Client (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Client (_waldo_classes["Endpoint"]):
        ...
        def _endpoint_func_call_prefix__waldo__send_msg(self,_active_event,_context,msg,_returning_to_public_ext_array=None):
            ...
            (self._partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG2(_active_event,_context,msg,) if _context.set_msg_send_initialized_bit_false() else None)
            (self._partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG3(_active_event,_context,msg,) if _context.set_msg_send_initialized_bit_false() else None)
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG2(self,_active_event,_context,msg=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "11__msg", _context.convert_for_seq_local(msg,_active_event,self._host_uuid)
                    )
            ...
            _threadsafe_queue = self._waldo_classes["Queue"].Queue()
            _active_event.issue_partner_sequence_block_call(
                _context,'receiveMSG2',_threadsafe_queue, '_first_msg')
            _queue_elem = _threadsafe_queue.get()
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__SeqSendMSG3(self,_active_event,_context,msg=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "15__msg", _context.convert_for_seq_local(msg,_active_event,self._host_uuid)
                    )
                ...
                result = ""
                _context.sequence_local_store.add_var(
                    "16__result",_context.convert_for_seq_local(result,_active_event,self._host_uuid))
            ...
            _threadsafe_queue = self._waldo_classes["Queue"].Queue()
            _active_event.issue_partner_sequence_block_call(
                _context,'receiveMSG3',_threadsafe_queue, '_first_msg')
            _queue_elem = _threadsafe_queue.get()
            ...
            return _context.sequence_local_store.get_var_if_exists("16__result")
...
def Server (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Server (_waldo_classes["Endpoint"]):
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__receiveMSG2(self,_active_event,_context,_returning_to_public_ext_array=None):
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__receiveMSG3(self,_active_event,_context,_returning_to_public_ext_array=None):
