    ...
    class _Server (_waldo_classes["Endpoint"]):
        ...
        def display_msg(self,msg):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                # transaction might return over-written/inconsistent values.
                try:
                    _to_return = self._endpoint_func_call_prefix__waldo__display_msg(_root_event,_ctx ,msg,[])
                except self._waldo_classes["BackoutException"]:
                    pass
        ...
        def _endpoint_func_call_prefix__waldo__display_msg(self,_active_event,_context,msg,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
        ...
        def _endpoint_func_call_prefix__waldo__nothing(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _context.signal_call(_active_event,_context.global_store.get_var_if_exists("2__nothing_func"),)
