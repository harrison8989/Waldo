...
def Ping (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Ping (_waldo_classes["Endpoint"]):
        ...
        def ping_seq(self,to_ping_with):
            ...
            while True:  # FIXME: currently using infinite retry 
                ...
                _to_return = self._endpoint_func_call_prefix__waldo__ping_seq(_root_event,_ctx ,to_ping_with,[])
        ...
        def _endpoint_func_call_prefix__waldo__ping_seq(self,_active_event,_context,to_ping_with,_returning_to_public_ext_array=None):
            if _context.check_and_set_from_endpoint_call_false():
                to_ping_with = _context.turn_into_waldo_var_if_was_var(to_ping_with,True,_active_event,self._host_uuid,False,False)
            ...
            if _returning_to_public_ext_array != None:
                ...
                return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__PingPongSeq(_active_event,_context,to_ping_with,) if _context.set_msg_send_initialized_bit_false() else None) if 0 in _returning_to_public_ext_array else _context.de_waldoify((self._partner_endpoint_msg_func_call_prefix__waldo__PingPongSeq(_active_event,_context,to_ping_with,) if _context.set_msg_send_initialized_bit_false() else None),_active_event))


            # otherwise, use regular return mechanism... do not de-waldo-ify
            return _context.flatten_into_single_return_tuple((self._partner_endpoint_msg_func_call_prefix__waldo__PingPongSeq(_active_event,_context,to_ping_with,) if _context.set_msg_send_initialized_bit_false() else None))
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__PingPongSeq(self,_active_event,_context,start_num=None,_returning_to_public_ext_array=None):
            ...
            if not _context.set_msg_send_initialized_bit_true():
                ...
                if _context.check_and_set_from_endpoint_call_false():
                    ...
                    _context.sequence_local_store.add_var(
                        "4__start_num", _context.convert_for_seq_local(start_num,_active_event,self._host_uuid)
                    )
                ...
                final_num = 0
                _context.sequence_local_store.add_var(
                    "5__final_num",_context.convert_for_seq_local(final_num,_active_event,self._host_uuid))

                pass

            _tmp0 = (_context.get_val_if_waldo(_context.sequence_local_store.get_var_if_exists("4__start_num"),_active_event) + _context.get_val_if_waldo(1 ,_active_event))
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("4__start_num"),_tmp0,_active_event):
                pass
            ...
            return _context.sequence_local_store.get_var_if_exists("5__final_num")
...
def Pong (_waldo_classes,_host_uuid,_conn_obj,*args):
    class _Pong (_waldo_classes["Endpoint"]):
        ...
        def _partner_endpoint_msg_func_call_prefix__waldo__final_pong(self,_active_event,_context,_returning_to_public_ext_array=None):
            ...
            _tmp0 = _context.sequence_local_store.get_var_if_exists("4__start_num")
            if not _context.assign(_context.sequence_local_store.get_var_if_exists("5__final_num"),_tmp0,_active_event):
                pass
